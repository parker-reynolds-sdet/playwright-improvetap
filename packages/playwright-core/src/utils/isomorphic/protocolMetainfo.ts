...
export const methodMetainfo = new Map<string, { internal?: boolean, title?: string, slowMo?: boolean, snapshot?: boolean, pausesBeforeInput?: boolean, pausesBeforeAction?: boolean, group?: string }>([
  ...
  ['Page.touchscreenDown', { title: 'Touch down', slowMo: true, snapshot: true, pausesBeforeAction: true, }],
  ['Page.touchscreenMove', { title: 'Touch move', slowMo: true, }],
  ['Page.touchscreenUp', { title: 'Touch up', slowMo: true, snapshot: true, }],
